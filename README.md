This GitHub repository displays all code used for data cleaning and data analysis for the SNAP vs Academic Success manuscript. Below is a description of each file in this repository:
